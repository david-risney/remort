...
- C# / .NET 8 (`net8.0-windows`) + WPF, CommunityToolkit.Mvvm, Wpf.Ui (WPF UI library for Windows 11 controls) (009-ui-modernization)
- JSON file via `ISettingsStore` / `JsonSettingsStore` (existing) (009-ui-modernization)
...
## Recent Changes
- 009-ui-modernization: Added C# / .NET 8 (`net8.0-windows`) + WPF, CommunityToolkit.Mvvm, Wpf.Ui (WPF UI library for Windows 11 controls)
